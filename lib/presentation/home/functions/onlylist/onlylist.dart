...
import 'package:calcu/data/sources/only_data.dart';
...
class OnlyList extends StatelessWidget {
  OnlyList({super.key});
  final OnlyData _onlyData = OnlyData();

  @override
  Widget build(BuildContext context) {
    User? user = _onlyData.getCurrentUser();
    return StreamBuilder<List<DocumentSnapshot>>(
      stream: _onlyData.onlyCalculosStream(),
        ...
        return Column(
          children: [
            ...
            Container(
              ...
              child: CountServices(userId: user!.uid, isTeamCount: false),
            ),
          ],
        );
      },
